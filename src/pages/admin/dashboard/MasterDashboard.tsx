...
export default function MasterDashboard() {
  ...
  const loadAgencies = async () => {
    setLoading(true);
    console.log("[MasterDashboard] Loading agencies...");
    ...
    if (error) {
      console.error("[MasterDashboard] Error fetching agencies:", error);
    ...
    console.log("[MasterDashboard] Loaded agencies:", withCounts.length);
    setAgencies(withCounts);
    setLoading(false);
  };

  const handleViewAgency = (agencyId: string, name: string) => {
    console.log(`[MasterDashboard] Entering View Mode for: ${name}`);
